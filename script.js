...
var random1 = document.getElementById("rand1-out");
var input1 = document.getElementById("rand-in1");
...
function addCandy() {
  picContainer.innerHTML += "<img width= '50px' src='IMG/candy.jpg'>";
}
...
randomColor.addEventListener("click", randomRgb);
...
document.getElementById("rand4").addEventListener("click", randclick);

function randclick() {
  var input21 = Number(document.getElementById("rand-in1").value);
  var input22 = Number(document.getElementById("rand-in2").value);
  input21 = Math.round(input21);
  input22 = Math.round(input22);

  console.log(input22);
  var randto = Math.random() * (input21 - input22);
  randto = Math.round(randto);
  document.getElementById("rand4-out").innerHTML = randto;
}
resetPage.addEventListener("click", resetPg);
...
function resetPg() {
  ...
  fonth1 = 24 + "px";
  document.getElementById("h1").style.fontSize = fonth1;
  fonth2 = 18 + "px";
  document.getElementById("h2").style.fontSize = fonth2;
  para1 = 16 + "px";
  document.getElementById("para").style.fontSize = para1;
  fonth3 = 18 + "px";
  document.getElementById("h3").style.fontSize = fonth3;
  fonth4 = 18 + "px";
  document.getElementById("h4").style.fontSize = fonth4;
  para2 = 16 + "px";
  document.getElementById("para1").style.fontSize = para2;
}
